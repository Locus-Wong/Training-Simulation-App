...
namespace A320AileronDampingTest {
	...
	public:
		MyForm6(System::Windows::Forms::Form ^ o)
		{
			otherform = o;
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"R AIL TEST          OK";
			// 
			// label4
			// 
			...
			this->label5->Size = System::Drawing::Size(298, 17);
			this->label5->TabIndex = 4;
			this->label5->Text = L"G DAMP FACTOR UP                 1.08";
			// 
			// label6
			// 
			...
			this->label6->Size = System::Drawing::Size(300, 17);
			this->label6->TabIndex = 5;
			this->label6->Text = L"G DAMP FACTOR DOWN           1.03";
			// 
			// label7
			// 
			...
			this->label7->Size = System::Drawing::Size(297, 17);
			this->label7->TabIndex = 6;
			this->label7->Text = L"B DAMP FACTOR UP                 1.20";
			// 
			// label8
			// 
			...
			this->label8->Text = L"B DAMP FACTOR DOWN           1.16";
			// 
			// button1
			// 
			...
			this->label9->Location = System::Drawing::Point(41, 461);
